 ...
 * `{ at, level, exclusive? }` `thresholds` for a fixed absolute scale (the fatigue and strength
 * views use this to keep their semantic bands stable); omitting it preserves the balance
 * behaviour — relative shading, which is the only thing "balance" can mean.
 */
