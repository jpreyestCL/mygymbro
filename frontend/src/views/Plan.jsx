...
export default function Plan() {
  ...
  /* The Coach's only entry point in the app. The same predicate every other Coach surface
     uses gates it, so an instance without the feature sees exactly the Plan screen it saw
     before. `mobile` is passed through and ignored for gating — this fork's apps talk to
     the API, so a signed-in user on the phone must see Coach. */
