...
export default {
  ...
  "This browser doesn't support passkeys, and this instance requires an account. Try a browser or device with passkey support.": 'Este navegador no admite passkeys y esta instancia requiere una cuenta. Prueba con un navegador o dispositivo compatible con passkeys.',
  ...
  'Note': 'Nota',
  'Anything to remember next time — seat position, grip, how it felt.': 'Lo que quieras recordar la próxima vez — posición del asiento, agarre, cómo se sintió.',
