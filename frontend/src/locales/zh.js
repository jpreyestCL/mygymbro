...
export default {
  ...
  "This browser doesn't support passkeys, and this instance requires an account. Try a browser or device with passkey support.": '此浏览器不支持通行密钥，且此实例需要账户。请换用支持通行密钥的浏览器或设备。',
  ...
  'Note': '备注',
  'Anything to remember next time — seat position, grip, how it felt.': '下次要记住的内容——座椅位置、握法、感受。',
  'Save note': '保存备注',
  'Last note': '上次备注',
