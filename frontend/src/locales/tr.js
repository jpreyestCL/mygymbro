...
export default {
  ...
  "This browser doesn't support passkeys, and this instance requires an account. Try a browser or device with passkey support.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor ve bu kurulum bir hesap gerektiriyor. Geçiş anahtarı destekleyen bir tarayıcı veya cihaz dene.',
  ...
  'Note': 'Not',
  'Anything to remember next time — seat position, grip, how it felt.': 'Bir dahaki sefere hatırlamak istediklerin — koltuk konumu, tutuş, nasıl hissettirdiği.',
